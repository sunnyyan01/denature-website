      ...
      <section className="relative h-[100vh] w-full">
        ...
        <div className="relative container mx-auto px-4 h-screen flex items-start pt-32">
          <div className="max-w-6xl mx-auto w-full pt-8 flex flex-col items-center">
            {/* Hero 主标题和副标题 */}
            <h1 className="text-5xl md:text-6xl font-bold text-center mb-4" style={{ color: '#204B2A' }}>
              Vegetarian Meals
            </h1>
            <p className="text-2xl md:text-3xl text-center mb-8 font-medium" style={{ color: '#4D4D4D' }}>
              Nutritious, balanced, and<br />designed for families and schools.
            </p>
            {/* Hero 按钮组整体下移120px，居中显示 */}
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-4 mt-[120px] mb-0 w-full sm:w-auto">
