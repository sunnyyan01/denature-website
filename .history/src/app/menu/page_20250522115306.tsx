...
// 定义分类类型
type Category = 'vegetarian' | 'healthy' | 'glutenfree';
...
// 分类常量
const categories = [
  { key: 'vegetarian' as Category, label: 'VEGETARIAN MEALS' },
  { key: 'healthy' as Category, label: 'HEALTHY MEALS' },
  { key: 'glutenfree' as Category, label: 'GLUTEN FREE MEALS' },
];
...
const weekBMenu = [
  {
    ...
    category: 'vegetarian' as Category,
    shopifyProductId: '2345678901',
    shopifyVariantId: '8765432109',
  },
  {
    id: 7,
    ...
    shopifyProductId: '3456789012',
    shopifyVariantId: '7654321098',
  },
  {
    id: 8,
    ...
    category: 'healthy' as Category,
    shopifyProductId: '4567890123',
    shopifyVariantId: '6543210987',
  },
  {
    id: 9,
