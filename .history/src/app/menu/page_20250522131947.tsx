                  ...
                  <div className="flex-1 flex flex-col p-5">
                    ...
                    <div className="mt-auto pb-2">
                      ...
                      {item.name === 'Pan-Fried Veggie Dumplings with Fresh Salad' && (
                        <>
                          <div id="product-component-1747880333218"></div>
                          <Script id="shopify-buy-button-1747880333218" strategy="afterInteractive">
                            {`
                              (function () {
                                var scriptURL = 'https://sdks.shopifycdn.com/buy-button/latest/buy-button-storefront.min.js';
                                if (window.ShopifyBuy) {
                                ...
                                function ShopifyBuyInit() {
                                  ...
                                  ShopifyBuy.UI.onReady(client).then(function (ui) {
                                    ui.createComponent('product', {
                                      id: '8837234786516',
                                      node: document.getElementById('product-component-1747880333218'),
                                      moneyFormat: '%24%7B%7Bamount%7D%7D',
                                      options: {
                                        "product": {
                                          "contents": {
                    ...
                    <Link href={`/menu/${item.id}`} legacyBehavior>
                      <a className="block mt-2 text-center text-gray-400 text-xs hover:text-gray-600 transition-colors">More info</a>
                    </Link>
                  </div>
                </div>
              ))}
