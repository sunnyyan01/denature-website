        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-6 relative">
            ...
            <button
              ...
              onClick={() => {
                // 触发Shopify Buy Button的Add to cart，并带上line item property
                const comp = window.ShopifyBuy && window.ShopifyBuy.UI && window.ShopifyBuy.UI.components && window.ShopifyBuy.UI.components.product && Array.isArray(window.ShopifyBuy.UI.components.product)
                  ? window.ShopifyBuy.UI.components.product.find(c => c.model && c.model.title === modalMeal)
                  : null;
                if (comp && selectedTime) {
                  comp.props.options.product.events.addVariantToCart = function(product) {
