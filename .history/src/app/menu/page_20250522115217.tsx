...
interface MenuItem {
  ...
  image: string;
  category: Category;
  shopifyProductId?: string; // 添加 Shopify 产品 ID
  shopifyVariantId?: string; // 添加 Shopify 变体 ID
}
...
const weekAMenu = [
  ...
  },
  {
    ...
    category: 'healthy',
    shopifyProductId: '1234567890', // 替换为实际的 Shopify 产品 ID
    shopifyVariantId: '9876543210', // 替换为实际的 Shopify 变体 ID
  },
];
