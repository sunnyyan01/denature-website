      ...
      <section className="py-24" style={{ background: '#F8F6F1' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 font-heading" style={{ color: '#204B2A' }}>Our Mission</h2>
            <div className="space-y-6 text-lg leading-relaxed" style={{ color: '#4D4D4D' }}>
              <p>
      ...
      <section className="py-24" style={{ background: '#F2F3EE' }}>
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-4xl font-bold mb-8 text-center" style={{ color: '#204B2A', fontWeight: 700 }}>
              Still Wondering What to Pack for Your Child's Lunch Tomorrow?
            </h2>
            <div className="space-y-8" style={{ color: '#4D4D4D' }}>
              ...
              <p className="text-center text-2xl font-bold" style={{ color: '#204B2A' }}>
              ...
              <p className="text-center text-xl font-bold" style={{ color: '#204B2A' }}>
