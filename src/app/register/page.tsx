...
export default function RegisterPage() {
  ...
  useEffect(() => {
    ...
    if (emailUser || googleUser) {
      setUpNewUser(emailUser || googleUser);
      router.push("/menu");
    }
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-gray-100 p-8">
      <div className="bg-[#E2DED0] p-8 rounded-lg shadow-md w-full max-w-md mb-4">
        <h2 className="text-2xl text-[#373D27] font-bold text-center mb-6">Register</h2>
        <form>
          <div className='mb-4'>
            <label htmlFor="name" className="block text-[#373D27] text-sm font-bold mb-2">
              Name
            </label>
            <input
              type="text"
          ...
          <div className="flex items-center justify-between">
            ...
            >
              {emailLoading ? 'Please wait...' : 'Register'}
            </Button>
          </div>
        </form>
      ...
      <div className="bg-[#E2DED0] p-8 rounded-lg shadow-md w-full max-w-md mb-4">
        ...
        >
          {googleLoading ? 'Please wait...' : 'Register with Google'}
        </Button>
      </div>
      <div className="bg-[#E2DED0] p-8 rounded-lg shadow-md w-full max-w-md flex flex-col items-center">
        <p className='text-[#373D27] font-semibold'>Already have an account?</p>
        <a className="text-[#425A26] text-lg font-bold" href="/login">Log in here &gt;</a>
      </div>
    </div>
  );
}