    ...
    <main className="min-h-screen pt-32">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto px-6 sm:px-10 lg:px-16">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12" style={{ background: '#FAFAF7' }}>
            ...
            <div className="space-y-8 text-[17px] leading-8" style={{ color: '#4D4D4D' }}>
              <p>
                ...
                Nutrition holds the power to heal, transform, and uplift life.<br />
              ...
              <blockquote className="border-l-4 pl-6 py-4 my-6 bg-[#f9f9f6] text-lg italic text-[#5A5A4A]" style={{ borderColor: '#E6E6D6' }}>
                Though the journey was difficult, it awakened a profound understanding of the connection between food and the body:<br />
              ...
              <p className="font-medium" style={{ color: '#204B2A' }}>
              ...
              <div className="rounded-lg p-8 my-8 text-center" style={{ background: '#F5F9F5' }}>
                <span className="text-lg text-green-900 font-semibold">Whether you're a vegetarian, gluten-sensitive, or simply seeking a cleaner and more mindful way to eat,<br />DE NATURE is here to serve every meal with heart.</span>
              </div>
              <p>
